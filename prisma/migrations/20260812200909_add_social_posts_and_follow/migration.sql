...
ALTER TYPE "ReportTargetType" ADD VALUE 'POST_COMMENT';
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_animeId_fkey" FOREIGN KEY ("animeId") REFERENCES "Anime"("id") ON DELETE SET NULL ON UPDATE CASCADE;
